...
Node x, & dist k 
Find min value among descendants of x whose depth <= depth[x] + k
So nodes lie in subtree of x ->  Euler Tour interval
Upto certain depth

[tin[x], tout[x]] Find min value subject to depth[x] <= depth[x] + k
